...
public final class TermuxActivity extends Activity implements ServiceConnection {
    ...
    void checkForFontAndColors() {
        try {
            @SuppressLint("SdCardPath") File fontFile = new File("/data/data/com.allplatform.box86/files/home/.termux/font.ttf");
            @SuppressLint("SdCardPath") File colorsFile = new File("/data/data/com.allplatform.box86/files/home/.termux/colors.properties");
